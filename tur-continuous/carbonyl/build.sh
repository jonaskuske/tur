...
_CHROMIUM_VERSION=111.0.5511.1
TERMUX_PKG_VERSION=0.0.0-git
TERMUX_PKG_SRCURL=git+https://github.com/fathyb/carbonyl
...
termux_step_post_get_source() {
	...
	./scripts/gclient.sh sync --with_branch_heads --with_tags --no-history --verbose
...
" >> $_common_args_file
	...
	./scripts/gn.sh gen $TERMUX_PKG_BUILDDIR/out/Release --export-compile-commands || bash
}
